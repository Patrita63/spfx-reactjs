...
var ListItem = /** @class */ (function (_super) {
    ...
    ListItem.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.container },
            React.createElement(TextField, { label: "Title", required: true, defaultValue: title, onChanged: this.handleTitleChange.bind(this), onGetErrorMessage: this.handleValidationError.bind(this) }),
            React.createElement(PrimaryButton, { text: "Save", onClick: this.handleEdit.bind(this) }),
            React.createElement(Button, { text: "Cancel", onClick: this.handleCancel.bind(this) }),
            React.createElement(Button, { text: "Delete", onClick: this.handleDelete.bind(this) })));
    };
    return ListItem;
}(React.Component));
